...
在本节中，您将使用Yeoman generator for Office Add-ins创建一个基于React的Office Add-ins项目。您还将使用Excel JavaScript API创建一个表格，并基于它创建图表。
...
在本节中，您将在上一节建立的Office Add-ins项目基础上，使用Custom Functions从Web Service中获取数据。
